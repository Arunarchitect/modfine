"""
Django settings for modfine project.
...
SECRET_KEY = 'django-insecure-%f&053zz*131c4v)252p$f6s!q@i2!=5*+5$u$m5ww97$wpipk'
...
WSGI_APPLICATION = 'modfine.wsgi.application'
